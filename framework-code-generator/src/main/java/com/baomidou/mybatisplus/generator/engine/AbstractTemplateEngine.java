...
public abstract class AbstractTemplateEngine {
        ...
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                if (null != tableInfo.getDtoName() && null != pathInfo.get(ConstVal.DTO_PATH)) {
                    String dtoPath = String.format((pathInfo.get(ConstVal.DTO_PATH) + File.separator + tableInfo.getDtoName() + suffixJavaOrKt()), entityName);
                    if (isCreate(FileType.DTO, dtoPath)) {
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        objectMap.put("superVOClassPackage", config.getSuperVOClass());
        objectMap.put("superVOClass",getSuperClassName(config.getSuperVOClass()));
        objectMap.put("superDTOClassPackage", config.getSuperDTOClass());
